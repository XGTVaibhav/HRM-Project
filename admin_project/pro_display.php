...
<main class="mt-5 pt-3">
    <div class="container-fluid ">
        <h2 align="center"><b>Manage Project List</b></h2><hr>
        <table id="example" class="table table-striped table-responsive" style="width:100%">
            ...
            <?php
                ...
                $query = "SELECT * FROM `new_project` ORDER BY id DESC";
                ...
                if ($total != 0) {
                    ...
                    while ($result = mysqli_fetch_assoc($data)) {
                        ...
                        echo "<tr>
                            ...
                            <td>" . $result['status'] . "</td>
                            <td>
                                <a class='btn text-white btn-info mb-2' style='font-size: 14px;' href='pro_update.php?id=$result[id]'><i class='fa fa-edit'></i></a>
                                <a class='btn text-white btn-danger mb-2' style='font-size: 14px;' href='pro_delete.php?id=$result[id]'><i class='fa fa-trash'></i></a>
                                <a class='btn text-white btn-success' style='font-size: 14px;' href='pro_displays.php?id=$result[id]'><i class='fa fa-eye'></i></a>
                            </td>
                        </tr>";
                    }
                } else {
