...
<main class="mt-5 pt-3">
    <div class="container">
    <h2><b>New Ticket</b></h2><hr>
        
        <form class="row g-3 ms-2 me-2" method="POST" enctype="multipart/form-data" id="taskForm" novalidate>
                <div class="col-md-6">
...
if (isset($_POST['submit'])) {
  ...
  $e_name=$_POST['emp_name'];
   ...
   $querry= "INSERT INTO `new_task`(`emp_id`, `emp_name`, `project_name`, `description`,`a_task`, `start_date`, `end_date`,  `upload`, `status`) VALUES ('$e_id','$e_name','$p_name','$d_name','$a_task','$s_date','$e_date',' $folder','$status')";
