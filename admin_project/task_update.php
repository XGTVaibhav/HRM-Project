...
<form class="row g-3 ms-2 me-2" method="POST" enctype="multipart/form-data">
            <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <label for="inputAddress" class="form-label">Project Description<span class="text-danger" style="font-size: 1.2em;">*</span></label>
                    <input type="text" class="form-control" id="inputAddress" name="description" value="<?php echo $result['description']; ?>">
                  </div>
                  <div class="col-md-6">
                    <label for="inputAddress" class="form-label">Assign Ticket<span class="text-danger" style="font-size: 1.2em;">*</span></label>
                  ...
                  <div class="col-md-6">
                      ...
                      <div class="input-group mb-3">
                          <input name="upload" id="inputupload" class="form-control" type="file">
                          <input name="oldImg" class="form-control" type="hidden" value="<?php echo $result['upload']; ?>">
                      </div>

                      <?php if (!empty($result['upload'])) { ?>
                          <img src="<?php echo $result['upload']; ?>" alt="Uploaded Image" width="100px" class="mt-2 img-thumbnail">
                          <h6 class="text-end"><?php echo $result['upload']; ?></h6>
                      <?php } ?>
                  </div>

                  <div class="col-md-6">
                    <label for="inputState" class="form-label">Status<span class="text-danger" style="font-size: 1.2em;">*</span></label>
...
if (isset($_POST['update'])) {
  ...
  $e_name=$_POST['emp_name'];
    ...
    $query="UPDATE `new_task` SET emp_id='$e_id',emp_name='$e_name', project_name='$p_name',description='$d_name', a_task='$a_task',start_date='$s_date',end_date='$e_date',upload='$folder',`status`='$status'where id='$idd' ";
   $data=mysqli_query($conn,$query);
