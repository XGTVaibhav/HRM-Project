...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $labourWelfare      = test_input($_POST['hra']); // Assuming 'hra' is the correct field name
    ...
    $insertQuery = "INSERT INTO emp_salary (emp_id, pday, emp_name, basicsalary, allowances, da, esi, pf, conveyance, month, medicalallowance, hra, tds, in_hand, netsalary)
                    VALUES ('$emp_id', '$pday', '$emp_name', '$basicSalary', '$allowances', '$da', '$esi', '$pf', '$conveyance', '$month', '$medicalAllowance', '$labourWelfare', '$tds', '$inhand', '$netSalary')";
