...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT myfile FROM emp_notice WHERE id = $id";
    ...
    $deleteQuery = "DELETE FROM emp_notice WHERE id = $id";
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            window.location.href = 'emp_deletenotice.php?id=$id&confirm=true';
        } else {
