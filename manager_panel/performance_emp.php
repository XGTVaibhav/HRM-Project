...
<main class="mt-5 pt-3">
    <div class="container-fluid">
        <center><h2><b>Manage Monthly Performance</b></h2><center><hr>
        <hr>
                ...
                <tbody>
                    ...
                    while ($result = mysqli_fetch_assoc($data)) {
                        ...
                        echo "<tr>
                            ...
                            <td>
                                <div class='btn-group'>
                                    <a href='perfromance_update.php?id=" . $result['id'] . "' class='btn btn-info text-white'><i class='fa fa-edit' style='font-size: 14px;'></i></a>
                                    <a href='performance_delete.php?id=" . $result['id'] . "' class='btn btn-danger text-white' style='background-color: #ed112e; margin-left: 20px;'><i class='fa fa-trash' style='font-size: 14px;'></i></a>
                                </div>
                            </td>
                        </tr>";
                        $no++;
