...
<main class="mt-5 pt-3">
    ...
    <h2><b>Employee Performance Form-Update</b></h2><hr>
        <form action="#" method="POST">
                   ...
                   <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="dept" class="form-control" value="<?php echo $show['dept'];?>" required>
                            ...
                            <option value="Software Engineer" <?php echo ($show['dept']=='Front-End Developer') ? 'selected' :'';?>>Front-End Developer</option>
                            <option value="Software Developer"  <?php echo ($show['dept']=='Back-End Develope') ? 'selected' :'';?>>Back-End Develope</option>
                            <option value="HR Department" <?php echo ($show['dept']=='Software Developer') ? 'selected' :'';?>>Software Developer</option>
                            <!-- <option value="Project Manager" <?php echo ($show['dept']=='Fullstack Developer') ? 'selected' :'';?>>Fullstack Developer</option> -->
                            <option value="Software Engineer" <?php echo ($show['dept']=='Manager') ? 'selected' :'';?>>Manager</option>
                            <!-- <option value="HR Department" <?php echo ($show['dept']=='Digital marketing executive') ? 'selected' :'';?>>Digital marketing executive</option> -->
                            <!-- <option value="Project Manager" <?php echo ($show['dept']=='Data Analyst') ? 'selected' :'';?>>Data Analyst</option> -->
                            <option value="Software Developer"  <?php echo ($show['dept']=='HR') ? 'selected' :'';?>>HR</option>
                        </select><br>
          ...
          <button type="submit" class="btn btn-primary" name="submit">Update Rating</button>
        </div>
   ...
   if ($data) {
            ...
            echo "<script>
                Swal.fire({
                    ...
                    window.location.href = 'performance_emp.php';
                });
            </script>";
        } else {
