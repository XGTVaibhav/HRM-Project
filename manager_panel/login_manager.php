...
<body>
                    ...
                    <div class="card bg-dark text-white ecrd shadow-lg rounded">
                        <div class="card-body p-5 text-center">
                            <div class="mb-md-5 mt-md-4 pb-5">
                                <h2 class="fw-bold mb-2 text-uppercase"><i class="fa-solid fa-user"></i>Manager Login</h2>
    ...
    if (isset($_POST['login'])) {
        ...
        $query = "SELECT * FROM add_employe Where emp_id ='$email' && emp_password ='$pwd' &&  	designation = 'Manager' ";
        ...
        if ($total == 1) {
            ...
            // Show Small-sized SweetAlert for successful login
            ...
            // Show Small-sized SweetAlert for login failure
            echo '<script type="text/javascript">';
            echo 'Swal.fire({
                        title: "Login Failed",
    ...
    <style>
        /* Custom CSS for Small-sized SweetAlert */
        .small-sweetalert {
