                ...
                <div class="col-md-6">
                    <div class="card border border-dark text-dark box-color h-100">
                        <a href="project_display.php" style="text-decoration: none; color: inherit;">
                            ...
                            <img src="../images/img-6.jpeg" alt="Employee Image" class="card-image" style="max-width: 300px; max-height: 200px;">
                ...
                <div class="col-md-6">
                    <div class="card border border-dark text-dark box-color h-100">
                        <a href="task_display.php" style="text-decoration: none; color: inherit;">
                            <div class="card-body py-2">
                            <img src="../images/img-3.jpeg" alt="Employee Image" class="card-image" style="max-width: 300px; max-height: 200px;">
