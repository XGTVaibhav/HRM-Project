...
<main class="mt-5 pt-3">
 <h2><b>Update Assign Project</b></h2>
...
<?php 
    if (isset($_POST['Update'])) {
      ...
      $query="UPDATE new_project SET emp_id='$e_id',emp_name='$e_name', project_name='$p_name',description='$d_name',start_date='$s_date',end_date='$e_date',members='$members', team_size='$t_size' ,links='$links',status='$status' where id='$idd' ";
      $data=mysqli_query($conn,$query);
