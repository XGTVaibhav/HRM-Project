...
if ($total != 0) {
    ...
    <div class="container-fluid">
        <center><h2 id="top"><b>Notice</b></h2></center><hr>
        <table id="example" class="table table-striped" style="width:100%">
            ...
            <tbody>
                ...
                // Assuming $data is your result set
                while ($result = mysqli_fetch_assoc($data)) {
                    ...
                    // Check if Emp_File (myfile) exists before trying to display it
                    if (!empty($result['myfile'])) {
                        echo '<img src="' . $result['myfile'] . '" alt="Employee File">';
                    } else {
                        echo 'No file';
                    }
