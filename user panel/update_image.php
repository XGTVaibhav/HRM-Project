...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($new_image['size'] > 0) {
        ...
        if (move_uploaded_file($new_image['tmp_name'], $new_image_path)) {
            ...
            $update_query = "UPDATE new_task SET upload = '$new_image_path' WHERE id = '$task_id'";
            $update_result = mysqli_query($conn, $update_query);

            if ($update_result) {
                // Redirect back to the view page after updating
                header("Location: view_image.php?id=$task_id");
                exit();
            } else {
...
<body>
    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <form action="update_image.php?id=<?php echo $task_id; ?>" method="post" enctype="multipart/form-data" class="mt-3" id="updateForm" onsubmit="return validateForm()">
                <div class="mb-3">
    ...
    <script>
        document.getElementById('updateForm').addEventListener('submit', function () {
            ...
            setTimeout(function () {
                window.location.href = 'task_view.php?id=<?php echo $task_id; ?>';
            }, 100);
        });
    </script>
    <script>
